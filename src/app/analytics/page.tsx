      ...
      {isConnected && stats && (
        <div className="flex flex-col gap-10">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 bg-[#FF5FCF] border-2 border-black p-6 shadow-[4px_4px_0_rgba(0,0,0,1)]">
              <DonutChart
                label="By Tier"
                segments={[
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {stats.longest && (
                <div className="bg-[#FF5FCF] border-2 border-black p-4 shadow-[4px_4px_0_rgba(0,0,0,1)] flex flex-col gap-1">
          ...
          {stats.topSenders.length > 0 && (
            <section>
              ...
              <div className="flex flex-col gap-2 bg-[#FF5FCF] border-2 border-black p-4 shadow-[4px_4px_0_rgba(0,0,0,1)]">
